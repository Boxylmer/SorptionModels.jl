module SorptionModels
    ...
    # export TODO, analysis may not be ready for public use
    ...
    include(joinpath("Writers", "WriteMobilityOrThermoFactor.jl"))
    # thermodynamic factor implemented above alongside mobility. 
